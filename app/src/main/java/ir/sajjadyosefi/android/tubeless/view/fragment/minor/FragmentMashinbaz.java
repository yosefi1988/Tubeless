...
public class FragmentMashinbaz extends Fragment {
    ...
    public FragmentMashinbaz() {


    }
    public FragmentMashinbaz(Context context) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        viewPager.setAdapter(new FragmentMashinbazAdapter(context,getChildFragmentManager()));
