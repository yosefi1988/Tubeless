...
import ir.sajjadyosefi.android.tubeless.widget.DoubleHeaderTestAdapter;
import ir.sajjadyosefi.android.tubeless.widget.recyclerview.decoration.DoubleHeaderDecoration;


public class DoubleHeaderActivity extends BaseDecorationActivity implements RecyclerView.OnItemTouchListener {

    private DoubleHeaderDecoration decor;

    @Override
    protected void setAdapterAndDecor(RecyclerView list) {
        final DoubleHeaderTestAdapter adapter = new DoubleHeaderTestAdapter(this);
