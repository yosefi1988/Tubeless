...
public class FragmentYafteha extends Fragment {
    ...
    public FragmentYafteha() {
    }


    public FragmentYafteha(Context context) {
    ...
    public FragmentYafteha newInstance(Context context, int page, int list) {
        this.context = context ;
        Bundle args = new Bundle();
        args.putInt(ARG_PAGE, page);
        args.putInt(ARG_LIST, list);
        FragmentYafteha fragment = new FragmentYafteha();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        viewPager.setAdapter(new FragmentYaftehaAdapter(context,getChildFragmentManager()));
