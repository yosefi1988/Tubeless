...
public class FragmentTamirgah extends Fragment {
    ...
    public FragmentTamirgah() {


    }
    public FragmentTamirgah(Context context) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        viewPager.setAdapter(new FragmentTamirgahAdapter(context,getChildFragmentManager()));
