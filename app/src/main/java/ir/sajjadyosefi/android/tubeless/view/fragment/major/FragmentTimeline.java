package ir.sajjadyosefi.android.tubeless.view.fragment.major;
...
public class FragmentTimeline extends Fragment {
    ...
    public FragmentTimeline(Context context) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        viewPager.setAdapter(new FragmentTimelineAdapter(context,getChildFragmentManager()));
