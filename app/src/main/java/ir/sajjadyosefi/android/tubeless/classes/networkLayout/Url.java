...
public class Url {
    ...
    public static final String POST_ADD_YAFTE_WITH_PIC          = Url.MEDIA_SERVER_ADDRESS + "UploadMediaUsers.aspx";
    public static final String POST_ADD_YAFTE                   = Url.MAIN_SERVER_ADDRESS + "Blog/newBlog";
    ...
    static final String POST_DELETE_BLOG_ITEM                   = Url.MAIN_SERVER_ADDRESS + "Blog/DisableBlog";

    public static final String SLAVE_FCM_KEY =                  "AAAA5-IKnxU:APA91bHPBHhQ0Np1SzAm2ACMWJlpBYAyGkO4a10Y8fuBjpn85FcvUBrdNX6QsU7lrlGjbxLp5FL2SVi3HzduWbNjz9ClJeZqK8546NRteFfOnnwiwdTFnGdbqOuB_BOZ5kNxfZgfTRtW";
}
