 ...
 */
public class AsyncCarCategoriesRecently extends AsyncTask<String, Void, CarCategoriesByCompanyResponse> {
    ...
    public AsyncCarCategoriesRecently(Context context, DilatingDotsProgressBar dilatingDotsProgressBar, List<CategoryItem> categoryList0, List<CategoryItem> categoryHeaderList0, StickyTestAdapter stickyTestAdapter, final EditText etSearch, int sortType ) {
