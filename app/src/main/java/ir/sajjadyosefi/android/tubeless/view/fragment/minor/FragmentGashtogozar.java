...
public class FragmentGashtogozar extends Fragment {
    ...
    public FragmentGashtogozar() {


    }
    public FragmentGashtogozar(Context context) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        viewPager.setAdapter(new FragmentGashtogozarAdapter(context,getChildFragmentManager()));
