...
//        dialog.setContentText(getString(R.string.registerFooterText));
//        dialog.setContentImage(getResources().getDrawable(R.mipmap.ic_launcher));
//        dialog.setPositiveListener(getString(R.string.register), new ColorDialog.OnPositiveListener() {
//            @Override
//            public void onClick(ColorDialog dialog) {
//                Toast.makeText(WebViewActivity.this, dialog.getPositiveText().toString(), Toast.LENGTH_SHORT).show();
//            }
//        }).setNegativeListener(getString(R.string.cancel), new ColorDialog.OnNegativeListener() {
//                @Override
//                public void onClick(ColorDialog dialog) {
//                    Toast.makeText(WebViewActivity.this, dialog.getNegativeText().toString(), Toast.LENGTH_SHORT).show();
//                    dialog.dismiss();
//                }
//            }).show();
