...
//                new SweetAlertDialog(MainActivity.this, SweetAlertDialog.ERROR_TYPE).setTitleText("Error")
//                        .setContentText(MainActivity.this.getString(R.string.NOTING_TO_SHOW))
//                        .show();
            }
        }
