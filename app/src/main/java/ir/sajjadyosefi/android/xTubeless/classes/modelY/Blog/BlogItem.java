...
public class BlogItem {
    ...
    private ir.sajjadyosefi.android.xTubeless.classes.model.Blog.Category category;
    ...
    public ir.sajjadyosefi.android.xTubeless.classes.model.Blog.Category getCategory() {
        return category;
    }

    public void setCategory(ir.sajjadyosefi.android.xTubeless.classes.model.Blog.Category category) {
