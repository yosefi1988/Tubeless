package ir.sajjadyosefi.android.xTubeless.classes.behavior;
...
public class CollapsingFilterBehavior extends CoordinatorLayout.Behavior<View> {
    ...
    public CollapsingFilterBehavior() {
    }


    public CollapsingFilterBehavior(Context context, AttributeSet attrs) {
