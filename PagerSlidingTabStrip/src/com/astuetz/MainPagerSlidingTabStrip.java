...
public class MainPagerSlidingTabStrip extends HorizontalScrollView {
	...
	public MainPagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
		...
		expandedTabLayoutParams = new LinearLayout.LayoutParams(Resources.getSystem().getDisplayMetrics().widthPixels/5, LayoutParams.MATCH_PARENT, 1.0f);
	...
	private void addTextTab(final int position, String title) {
		...
		IconTextView tab = new IconTextView(getContext());
		tab.setText(title);
	...
	private void updateTabStyles() {
		...
		for (int i = 0; i < tabCount; i++) {
			...
			if (v instanceof TextView) {
				...
				IconTextView tab = (IconTextView) v;
